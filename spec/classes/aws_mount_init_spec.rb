...
#    it { should contain_file('/somewhere/tmp') }
  ...
  context "no disks instance" do
    let(:facts) { { :ec2_instance_type => 'm3.2xlarge' } }
  ...
  context "two disk" do
    ...
    context "ephemeral disk" do
      let(:facts) { { :ec2_instance_type => 'm1.large', :ec2_block_device_mapping_ephemeral0 => '/dev/sdb', :ec2_block_device_mapping_ephemeral1 => '/dev/sdc' } }
